...
class StravaApiProvider:
    ...
    def make_request(self, user_name, url, params=None):
        ...
        if response.status_code == 429:
            raise Exception(
                "Erro ao acessar o strava muitas requisições, tente novamente mais tarde"
            )
    ...
    def get_segment_effort(self, user_name, segment_effort_id):
        ...
        """
        return self.make_request(
            user_name, f"{self.url}/segment_efforts/{segment_effort_id}"
        )
